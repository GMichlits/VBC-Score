...
Species = 'Hm'
Output_name = 'testforratios_trainA_DLD1_3'
mode = 'rel'
...
#data_abs_1 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/DLD1_setA_train_d','rb'))
#data_abs_2 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/RKO_setA_train_d','rb'))
#data_abs_3 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/NCIH1299_setA_train_d','rb'))

#data_abs_1 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/DLD1_setB_train_d','rb'))
#data_abs_2 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/RKO_setB_train_d','rb'))
#data_abs_3 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/NCIH1299_setB_train_d','rb'))

#data_abs_1 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/DLD1_setC_train_d','rb'))
#data_abs_2 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/RKO_setC_train_d','rb'))
#data_abs_3 = pickle.load(open('../../Gen_data/Novartis_tiled/50-50-splits/NCIH1299_setC_train_d','rb'))
        ...
        for pos in data_set:
            if pos in D16_woAA_d and CN_d[pos] == 1:
                ...
                if x == 'tracrv2':
                    ...
                    data_list.append(score)
                if x == 'combo':
                    print(pos + '\t' + str(D16_woAA_d[pos]) + '\t' + str(tracr_v2_3Nov_d[pos]))
