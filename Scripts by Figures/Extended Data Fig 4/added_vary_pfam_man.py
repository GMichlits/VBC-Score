...
x_name = ['blank','Pfam_dom','Pfam_fam','Pfam_rep','Pfam_dom+fam+rep','Pfam_dom+fam', 'random']
for x in x_name:
        ...
        if True: #pos in phylo_d:
            if True: # pos in AA_d:
                if True:# pos in inDelphi_infr_d:
                    ...
                    i_training += 1
                    #PHYLO
                    ['blank', 'Pfam_dom', 'Pfam_fam', 'Pfam_rep', 'Pfam_dom+fam+rep', 'Pfam_dom+fam',  'random']
                    if x == 'Pfam_dom':
                    ...
                    if x == 'Pfam_fam':
                        ...
                        data_list.append(score)
                    if x == 'Pfam_rep':
                        score = Pfam_repeat_d[pos]
                        data_list.append(score)
                    if x == 'Pfam_dom+fam+rep':
                        score = Pfam_domain_d[pos]
                        data_list.append(score)
                        score = Pfam_family_d[pos]
                        data_list.append(score)
    ...
    Feature_name_list = []
    ['blank', 'Pfam_dom', 'Pfam_fam', 'Pfam_rep', 'Pfam_all', 'Pfam_dom+fam', 'Pfam_dom+fam+rep', 'random']
    if x == 'Pfam_dom':
        Feature_name_list.append('dom')
    if x == 'Pfam_fam':
        Feature_name_list.append('fam')
    if x == 'Pfam_rep':
        Feature_name_list.append('rep')
    if x == 'Pfam_all':
        Feature_name_list.append('all')
    if x == 'Pfam_dom+fam':
        Feature_name_list.append('dom')
        Feature_name_list.append('fam')
    if x == 'Pfam_dom+fam+rep':
