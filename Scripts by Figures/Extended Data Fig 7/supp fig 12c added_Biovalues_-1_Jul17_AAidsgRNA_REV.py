...
Species = 'Hm'
Output_name = 'V2_AAID_sgRNA_-1_linreg_REVsup8'
...
x_name = ['blank','Doench2016','tracrv2','combsgRNA','AA-id','combo']
for x in x_name:
    ...
    for data_set in IMP_3_screens:
        for pos in data_set:
            if pos in AA_score_dv2 and pos in AA_type_cut:
                ...
                i_training += 1
                #PHYLO
                ['blank','Doench2016','tracrv2','combsgRNA','AA-id','combo']
                if x == 'Doench2016':
    ...
    if x == 'Doench2016':
        ...
        Feature_name_list.append('combsgRNA')
