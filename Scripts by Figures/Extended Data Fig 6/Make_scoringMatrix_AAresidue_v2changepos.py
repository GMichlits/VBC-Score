...
#AA_residue_d = pickle.load(open('../../Gen_properties/' + Species + '/property_sav/AA_residue_dv2.sav', 'rb'))
#AA_residue_d = pickle.load(open('../../Gen_properties/' + Species + '/property_sav/AA_residue_d+2.sav', 'rb'))
#AA_residue_d = pickle.load(open('../../Gen_properties/' + Species + '/property_sav/AA_residue_d+1.sav', 'rb'))
#AA_residue_d = pickle.load(open('../../Gen_properties/' + Species + '/property_sav/AA_residue_d-1.sav', 'rb'))
AA_residue_d = pickle.load(open('../../Gen_properties/' + Species + '/property_sav/AA_residue_d-2.sav', 'rb'))
###########################################################################
...
score_matrix_output = open(Species + '_AAlist_outm2_3NOV_June.txt','w')
