...
for guide in INDEL_DICT:
    ...
    sum_d2 = (sum(outframes_list_d2))
    sum_d18 = (sum(outframes_list_d18))
    if sum_d2 == 0:
        print(guide + 'division by 0 error')
        sum_d2 = 0.00001
    guide_inf_d18_vs_d2 = sum_d18/sum_d2
    if guide in sgRNA_subgroup_dict:
        if sgRNA_subgroup_dict[guide] == 'strong':
            print('strong' + '\t' + guide + '\t' + str(round(guide_inf_d18_vs_d2,4)) + '\t' )
        ...
        if sgRNA_subgroup_dict[guide] == 'medium':
            print('medium' + '\t' + guide + '\t' + str(round(guide_inf_d18_vs_d2,4)) + '\t' )
        ...
        if sgRNA_subgroup_dict[guide] == 'weak':
            print('weak' + '\t' + guide + '\t' + str(round(guide_inf_d18_vs_d2,4)) + '\t' )
    ...
    if guide in Ctrls_guides:
        print('ctrl' + '\t' + guide + '\t' + str(round(guide_inf_d18_vs_d2,4)) + '\t' )
